...
function showstatspop_view(date1,date2)
{
    ...
    xmlHttpReq.onreadystatechange = function() 
	{
		...
		var url = "popstatsview.php?date1="+date1+"&date2="+date2;
...
function showdivpop_view(value,snameen,sdtype,sof,sdsort,scat,msort,msortx)
{
	getHttpPost();
    xmlHttpReq.onreadystatechange = function() 
	{
		...
		var url = "popupdateview.php?v="+value+"&sname="+snameen+"&sdtype="+sdtype+"&sdsort="+sdsort+"&sof="+sof+"&scat="+scat+"&msort="+msort+"&msortx="+msortx;
	xmlHttpReq.open('POST',url, true);
	//xmlHttp.setRequestHeader("If-Modified-Since", "Sat, 1 Jan 2000 00:00:00 GMT");
    xmlHttpReq.send(null);
}
...
function setWOffice(value)
{
	if(value !='na')
	window.location.href='setwoffice.php?id='+value;
}
...
function showWarning(task,value)
{
	if(task !="")
	{
		...
		{
			var confirmx = window.confirm("YOU ARE ABOUT TO UPDATE THE CHOOSEN USER WITH THE NEW INFORMATION. THIS ACTION WILL NOT CAUSE ANY OTHER INFORMATION TO BE LOST SUCH AS IMAGES OR AGENT ID.\r\n\r\nIN THE EVENT THAT EXPRESS WALK-IN OPTION IS CHOSEN AND YOUR UPDATE STATES THAT THE ENTRY IS NOT HIRED OR ENTRY HAS NO SHOWN FOR INTERVIEW OR ORIENTATION COMPLETED IS NOT SET ALL INFORMATION REGARDING TO ORIENTATION OR INFORMATION AFTER WILL BE DELETED TO MAINTAIN STABILITY IN THE SYSTEM.\r\n\r\nAre You Sure You Want To Proceed?.\r\n\r\nTo Proceed, click Okay or To Cancel click Cancel");
			if(confirmx==true)
