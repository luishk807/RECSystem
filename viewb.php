        ...
        <div id="body_middle_middle">
        	<div id="body_content">
              <div id="message" name="message" class="white" style="text-align:center">
            	...
            	<form method="post" action="view.php" onsubmit="return checkFieldh()">Search For Entries Name: <input type="text" size="60" id="sname" name="sname" />&nbsp;&nbsp;<input type="submit" value="Submit" />&nbsp;Or&nbsp;
